        ...
        try (Client client = Client.builder()
            ...
            String SYSTEM_INSTRUCTION_TEXT = """
                    ...
                    **응답은 어떠한 추가 설명, 서론, 결론 없이 오직 JSON 배열 형식으로만 제공되어야 합니다.**
                    ...
                    - 'title': 해당 To-Do 항목의 간략하고 명확한 제목입니다. **명령형 동사로 시작하는 행동 중심의 키워드 구문이어야 하며, 무조건 공백 포함 15자 이하로 작성하세요(가장 중요: 이 제약을 반드시 지켜야 합니다. 15자를 초과할 경우 데이터베이스 저장에 실패합니다.).** (예: "이력서 프로젝트 경험 재구성", "클라우드 경험 구체화", "코딩 테스트 대비") 질문형이나 설명형 문구는 금지됩니다.
