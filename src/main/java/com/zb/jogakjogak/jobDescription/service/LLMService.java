                    ...
                    [
                      {
                        ...
                        "content": "이력서에 나열된 프로젝트 경험들을 채용 공고의 요구 기술 스택과 관련된 최신 프로젝트 위주로 재구성하고, 각 프로젝트에 대한 GitHub 저장소 링크를 명확히 추가해 보세요. 특히, 프로젝트 목표, 본인의 역할, 사용 기술, 달성한 성과(수치화 가능한 경우)를 상세하게 기술하면 인사 담당자가 지원자의 기여도를 명확히 파악하는 데 도움이 될 거예요.",
                        "memo": "",
                        "isDone": false
                      },
                      {
                        ...
                        "content": "채용 공고에서 요구하는 '클라우드 경험'에 맞춰, 과거 AWS EC2를 활용한 서비스 배포 경험을 구체적인 수치(예: '트래픽 처리량 20% 개선', '배포 시간 15% 단축')와 함께 서술하여 실제 업무 기여도를 명확히 강조해 보세요. AWS S3, Lambda, DynamoDB 등 다른 관련 서비스에 대한 이해도와 활용 경험이 있다면 이를 추가하여 클라우드 전반의 역량을 어필하는 것도 좋아요.",
                        "memo": "",
                        "isDone": false
                      },
                      {
                        ...
                        "title": "서류 제출 및 면접 준비",
                        "content": "A사의 서류 마감일(2025/07/15)에 맞춰 이력서와 자기소개서의 최종 검토 및 제출을 완료하고, 예상 면접 질문 리스트를 작성하여 답변을 준비해 보세요. 특히, 회사의 비전, 주요 서비스, 최근 기술 동향 등을 면밀히 조사하면 면접 시 회사에 대한 깊은 이해와 관심을 보여줄 수 있어요. 모의 면접을 통해 답변의 논리성 및 전달력을 점검하는 것도 중요해요.",
                        "memo": "",
                        "isDone": false
                      }
                    ]
